...
export interface GenericDateLineChartProps {
  id: string;
  seriesName?: string;
...
const GenericDateLineChart: FC<GenericDateLineChartProps> = ({
  id,
  data = [],
  hasBullets = true,
  hasZoom,
  ...
  const getClasses = () => {
    const classes = ["commons-generic-date-line-chart"];
  ...
  useEffect(() => {
    ...
    const series = chart.series.push(
      am5xy[smoothed ? "SmoothedXYLineSeries" : "LineSeries"].new(root, {
        ...
        ...seriesOptions,
        tooltip: am5.Tooltip.new(root, {
          labelText: "Date: {valueX} Value: {valueY}",
        }),
      })
    );
...
export default GenericDateLineChart;
