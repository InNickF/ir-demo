...
const LeasingActivityChart = dynamic(
...
export const LeasingActivity: FC<MarketAnalyticsChartProps> = ({
  headerActions,
  filters,
  ...props
}) => {
  ...
  return (
    ...
    >
      <div>
        {hasData ? (
          <LeasingActivityChart
            id="acq-leasing-activity-chart"
            data={formattedData}
          />
        ) : (
