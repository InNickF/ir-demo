...
const VacancyRatesChart = dynamic(
  () =>
    import(
...
export const VacancyRate: FC<MarketAnalyticsChartProps> = ({
  headerActions,
  filters,
  ...props
}) => {
    ...
    <CardWithHeader
      ...
      headerActions={
        <CurrentValueChartHeader
          value={
            hasData
              ? numberToPercent(formattedData[formattedData.length - 1].y)
              : null
          }
