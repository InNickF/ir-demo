import { useCompstackSaleCompsTrend } from "@/acquisitions/services/queries/market-analytics";
...
export const CompstackSaleCompsTrendChart: FC<
  CompstackCompsTrendChartProps
> = ({
  onAmountBulletClick,
  headerActions,
  title = "Sale Comps Trend",
  filters,
  ...props
}) => {
      ...
      <div>
        {hasData ? (
          <CompstackCompTrendChart
            id="acq-compstack-sale-comps-trend-chart"
            data={data}
