...
const { numberToDollar, readableNumber, numberToPercent } = amountConversions;
...
const columnHelper = createColumnHelper<StabilizedProperty>();

const useStabilizedPropertiesTable = (
  data: StabilizedProperty[],
  columns: ColumnDef<StabilizedProperty>[]
) => {
...
export const StabilizedPropertiesTable: FC<
  CompTableProps<StabilizedProperty, StabilizedPropertyTotals>
> = ({
  data,
  page,
  setPage,
  ...
  const table = useStabilizedPropertiesTable(data, columns);
  return (
    <>
      <TableCard.Body>
        <Table>
