...
import "../styles.css";
import { ProjectedNoiGrowth } from "@/modules/assets/typings/portfolio-growth";

export interface ProjectedNoiGrowthChartProps {
  id: string;
  data: ProjectedNoiGrowth[];
}

const ProjectedNoiGrowthChart: FC<ProjectedNoiGrowthChartProps> = ({
  id,
  data = [],
}) => {
...
export default ProjectedNoiGrowthChart;
