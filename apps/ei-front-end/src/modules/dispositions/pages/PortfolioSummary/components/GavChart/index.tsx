...
const GavChart = dynamic(() => import("./component/GavPieChart"), {
  ssr: false,
  loading: () => (
...
interface GavPortfolioChartProps {
...
export const GavPortfolioChart: FC<GavPortfolioChartProps> = ({
  filters,
  className,
  onClick,
}) => {
  ...
  const [filterBy, setFilterBy] = useState<ByOptions>(byOptions[0].value);
